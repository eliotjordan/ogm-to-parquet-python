...
- Outputs tokenizer.json, embeddings.safetensors, embeddings.bin, and metadata.json
...
3. **Model Distillation**: Distill all-MiniLM-L6-v2 with custom vocabulary
   ...
   - Outputs saved to `tmp/ogm-model/` (tokenizer.json, embeddings.safetensors, embeddings.bin)
